...
public class LoginClubAdminPageTestCase extends TestBase
{
	LoginPage loginPage;
	...
	TestUtil testUtil;
    String sheetName="ClubAdminLogin" ;
	
	public LoginClubAdminPageTestCase() 
	{
		super();
	}
	...
	public void loginPageTitleTest()
	{
		...
		Assert.assertEquals(title, "HANDELSGILLET","HomePage title not matched.");	
	}
	...
	//=============================================================================================================
		 ...
		 @DataProvider
	     public Object[][] getHGClubAdminLoginTestData()
	     {
		...
		@Test(priority=3, dataProvider="getHGClubAdminLoginTestData")
